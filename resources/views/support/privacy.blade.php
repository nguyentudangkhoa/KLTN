...
<section class="terms-of-use">
    ...
    <div class="terms">
        <div class="container">
            ...
            <p>We value the trust you place in us. That's why we insist upon the highest standards for secure
            ...
            <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing
                ...
                necessary</p>
            <p>first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a
                handful of model
            ...
            <p>Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words,
                consectetur, from
            ...
            <p> Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites
            ...
            <p> you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum
                generators on
