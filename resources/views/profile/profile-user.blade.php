  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        @else
        <img src="assets/AdminLTE/dist/img/{{ $user->image }}" class="img-circle elevation-2" alt="User Image">
        @endif

        </div>
        <div class="info">
          <a href="{{ route('profile',Auth::user()->id) }}" class="d-block">{{ $user->name }}</a>
        </div>
      </div>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <a href="#" class="btn btn-primary btn-block"><b>Thay đổi avartar</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-block btn-info">Thêm địa chỉ</button>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Chỉnh sửa thông tin cá nhân</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" id="form-user">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="name" class="form-control" name="inputName" id="inputName" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row" >
                        ...
                        <div class="col-sm-10">
                          <select name="gender" class="form-control" id="">
                            <option selected disabled>Vui lòng chọn giới tính của bạn</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputPhone" name="inputPhone" placeholder="Skills">
                        </div>
                      </div>
                      <div class="form-group row">
