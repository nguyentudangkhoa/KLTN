...
(function(h) {
    ...
    function Ea(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && (d && "Không có dữ liệu xuất kho" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Đầu tiên", sLast: "Cuối cùng", sNext: "Tiếp theo", sPrevious: "Về trang trước" },
            sEmptyTable: "Không có dữ liệu xuất kho",
            sInfo: "Hiển thị từ _START_ đến _END_ của _TOTAL_ kết quả",
            sInfoEmpty: "Hiển thị 0 to 0 of 0 Kết quả",
            sInfoFiltered: "(Đã lọc from _MAX_ total kết quả)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
